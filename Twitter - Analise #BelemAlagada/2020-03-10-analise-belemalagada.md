...
================
Rafael Barbosa
27 de abril, 2020 às 09:57

  - [R Markdown Document](#r-markdown-document)
...
Temos um banco de dados com 1295 linhas e 90 colunas, ou seja, 1295
...
```
    ...
    ## $ quoted_favorite_count   <int> NA, NA, NA, NA, 2060, 77, NA, NA, NA, NA, N...
    ## $ quoted_retweet_count    <int> NA, NA, NA, NA, 450, 8, NA, NA, NA, NA, NA,...
    ...
    ## $ quoted_followers_count  <int> NA, NA, NA, NA, 125, 849, NA, NA, NA, NA, N...
    ## $ quoted_friends_count    <int> NA, NA, NA, NA, 15, 314, NA, NA, NA, NA, NA...
    ## $ quoted_statuses_count   <int> NA, NA, NA, NA, 117, 1515, NA, NA, NA, NA, ...
    ...
    ## $ followers_count         <int> 461, 461, 719, 23, 735, 200, 200, 51, 341, ...
    ...
    ## $ favourites_count        <int> 5562, 5562, 66000, 3464, 21352, 2522, 2522,...
...
![](2020-03-10-analise-belemalagada_files/figure-gfm/localizacao_tweets-1.png)<!-- -->
...
![](2020-03-10-analise-belemalagada_files/figure-gfm/quantidade_grafico-1.png)<!-- -->
